...
import './Generarnuevaorden.css'

const Generarnuevaorden = () => {
...
return (
    ...
    <div className='row'>
      <div className='col-sm-12 col-md-10 col-xl-8 gencontenedor1' >
      ...
      <div className='col-sm-12 col-md-2 col-xl-4 gencontenedor2'>


      </div>

      <div className='col-sm-12 col-md-10 col-xl-8 gencontenedor3'>
      ...
      <div className='col-sm-12 col-md-2 col-xl-4 gencontenedor4'>


      </div>

      <div className='col-sm-12 col-md-6 col-xl-5 genacontenedor5'>
      ...
      <div className='col-sm-12 col-md-6 col-xl-7 gencontenedor6'>
      ...
      <div className='col-sm-12 col-md-7 col-xl-7 gencontenedor7'>
      ...
      <div className='col-sm-12 col-md-5 col-xl-5 gencontenedor8'>
      ...
      <div className='col-sm-12 col-md-12 col-xl-12 gencontenedor9'>
      ...
      <div className='col-sm-12 col-md-12 col-xl-12 gencontenedor10'>
        hola
...
export default Generarnuevaorden
